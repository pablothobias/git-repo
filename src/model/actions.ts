...
export const LOADING_FETCH_REQUEST = 'LOADING_FETCH_REQUEST';
...
interface LoadingRequestGithubUser {
    type: typeof LOADING_FETCH_REQUEST
};

export type ActionTypes =  RequestGithubUser | SuccessRequestGithubUser | FailureRequestGithubUser | LoadingRequestGithubUser;