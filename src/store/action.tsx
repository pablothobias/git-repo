import { ActionTypes,  SUCCESS_FETCH_REQUEST, REQUEST_GITHUB_USER, FAILURE_FETCH_REQUEST } from "../model/actions";
...
export { requestGithubUser, succesRequestFromGithub, failureRequestFromGithub };